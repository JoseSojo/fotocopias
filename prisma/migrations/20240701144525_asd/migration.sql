...
INSERT INTO "new_Report" ("createBy", "create_at", "delete_at", "downloader", "fecha", "objectType", "path", "reportId", "update_at") SELECT "createBy", "create_at", "delete_at", "downloader", "fecha", "objectType", "path", "reportId", "update_at" FROM "Report";
DROP TABLE "Report";
